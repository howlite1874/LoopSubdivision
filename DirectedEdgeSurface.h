...
struct HE_Vertex {
    ...
    int FDedge = -1;             //first directed edge 
...
class DirectedEdgeSurface
    ...
    /*added data written by Chenxin jiang*/
    std::vector<HE_Vertex> vertices;

    std::vector<HE_halfEdge> halfEdges;

    /*added function written by Chenxin Jiang*/
    void updateHalfEdges();

    void LoopSubdivision();

    std::vector<HE_Vertex> AdjacentVertex(int i);

    void adjustVertex(int i);
